...
class StandardShowcaseDrawer implements ShowcaseDrawer {
    ...
    protected final Drawable handDrawable;
    ...
    public StandardShowcaseDrawer(Resources resources, Resources.Theme theme) {
        ...
        handDrawable = ResourcesCompat.getDrawable(resources, R.drawable.hand, theme);
    }
    ...
    public void drawShowcase(Bitmap buffer, float x, float y, float scaleMultiplier) {
        ...
        handDrawable.setBounds((int) x, (int)y, left + getShowcaseWidth(), top + getShowcaseHeight());
        handDrawable.draw(bufferCanvas);
    }
